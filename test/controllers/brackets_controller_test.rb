...
class BracketsControllerTest < ActionController::TestCase
  ...
  test "should create bracket" do
    assert_difference('Bracket.count') do
      post :create, bracket: { BracketType_ID: @bracket.BracketType_ID, NumOfTeams: @bracket.NumOfTeams, name: @bracket.name }
    end
  ...
  test "should update bracket" do
    patch :update, id: @bracket, bracket: { BracketType_ID: @bracket.BracketType_ID, NumOfTeams: @bracket.NumOfTeams, name: @bracket.name }
    assert_redirected_to bracket_path(assigns(:bracket))
  end
